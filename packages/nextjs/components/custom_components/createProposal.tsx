...
console.log(isSoleOwner)
  ...
  return (
    <div>
         <Select options={selectOptions} onChange={(newValue)=>{setValue(Number(newValue))}}   />
         {(() => {
        switch (value) {
          case 3:
            return (
             <RentComponent tokenId={tokenId} />
            );
           case 0:
            return (
                <div>
          ...
          />:null}
                    <Button label="List for Rent" onClick={()=>{listForRent()}} />
                </div>
            );
            case 1:
            return (
          ...
          />:null}
                    <Button label="UnList for Rent" onClick={()=>{unListForRent()}} />
                </div>
            );
